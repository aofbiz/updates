  ...
  useEffect(() => {
    ...
    const runAutoBackup = async () => {
      try {
        ...
        // 4. Initialize Google Script & Client if needed
        if (!window.google) {
          await loadGoogleScript().catch(e => console.error("Script load failed", e))
        }

        console.log("Backup is due! Waiting for user interaction (Settings page) to re-auth if needed.")
